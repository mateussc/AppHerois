...
import br.usjt.ads20.appfilmes.presenter.ListarHeroisPresenter;

public class ListarHeroisActivity extends AppCompatActivity implements ListaerHeroisView {
    public static final String HEROI = "br.usjt.ads20.appfilmes.descricao";
    private String url = "";
    Heroi[] lista;
    Activity atividade;

    ListarHeroisPresenter presenter = new ListarHeroisPresenter(this);
...
//        lista = Dados.buscarHerois(chave);
        ...
        lista = presenter.carregarHerois(herois, chave);
    ...
    @Override
    public ArrayList<Heroi> carregarHerois() {
        return null;
    }
}